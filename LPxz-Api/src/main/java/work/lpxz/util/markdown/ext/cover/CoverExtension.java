package work.lpxz.util.markdown.ext.cover;
...
import work.lpxz.util.markdown.ext.cover.internal.CoverDelimiterProcessor;
import work.lpxz.util.markdown.ext.cover.internal.CoverHtmlNodeRenderer;
import work.lpxz.util.markdown.ext.cover.internal.CoverTextNodeRenderer;
    ...
    public void extend(TextContentRenderer.Builder rendererBuilder) {
        rendererBuilder.nodeRendererFactory(new TextContentNodeRendererFactory() {
            ...
            public NodeRenderer create(TextContentNodeRendererContext context) {
                return new CoverTextNodeRenderer(context);
            }
        });
    }
}
