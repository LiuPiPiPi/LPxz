...
import { Divider, Tag, Table, Button, message, Popconfirm, Modal, Form, DatePicker } from 'antd'
...
const ExceptionLog = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, row) => (
                <>
                    <Button size='small' type='primary' onClick={() => handleOpenDialog(row)}>详情</Button>
